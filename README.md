# 👋 Hi, I'm Beauti Kumari

**Software Engineer | ML Researcher | M.S. Computing & Information Sciences**

I am a results-driven Software Engineer with **5+ years of experience** building scalable, production-grade enterprise applications. Currently, I am a Graduate Researcher at the **University of North Florida**, specializing in Multimodal Deepfake Detection and AI-driven analysis.

---

## 🚀 Professional Overview
* **Software Engineering:** 5+ years at **DXC Technology** developing secure applications using Java, Spring Boot, and AWS.
* **AI/ML Research:** Graduate Research focused on deepfake detection using CNNs, LSTMs, and Vision-Language Models.
* **Cloud Certified:** Microsoft Certified Azure Developer Associate (**AZ-204**) and Azure Fundamentals (**AZ-900**).
* **Education:** Master of Science in Computing & Info Sciences, UNF (Graduated Dec 2025).
* **Work Authorization:** Authorized to work full-time in the U.S. on OPT.
...
* **Programming:** Java (8/11), Python, SQL (T-SQL, PL/SQL), JavaScript.
* **Web & Frontend:** Angular, ReactJS, Bootstrap, HTML5, CSS3.

### ⚙️ Backend & Enterprise Systems
* **Frameworks:** Spring Boot (Microservices), Spring Security, Hibernate, Node.js.
* **Database Management:** SQL Server (SSMS), MySQL, MongoDB.
* **API Development:** RESTful APIs, Postman, Integration of 3rd-party services.

### 🧠 Machine Learning & AI Research
* **Deep Learning:** TensorFlow, Keras, PyTorch, CNN, RNN, LSTM.
* **Data Science:** Pandas, NumPy, Scikit-learn, Matplotlib.
* **Signal & Computer Vision:** OpenCV, Librosa (FFT, MFCCs), Spectrogram analysis.
* **AI Tools:** OpenAI API, LLaMA-Vision, DeepSeek-Vision, Janus-Pro, Gemma Vision.

### ☁️ Cloud & DevOps (Production Ready)
* **Cloud Platforms:** AWS (EC2, S3, Lambda), Microsoft Azure.
* **CI/CD & Automation:** Jenkins, GitHub Actions, Maven, Docker.
* **Version Control & Agile:** Git (GitFlow), SVN, Jira, Agile/Scrum.
...
## 📣 Connect with Me
- 🌐 [Portfolio](https://github.com/ByteBelleCodes)
- 📧 [Email](mailto:beautikumari1612@gmail.com)
- 🧑‍💻 [LinkedIn](https://linkedin.com/in/beauti-kumari)
- 🐦 [GitHub](https://github.com/ByteBelleCodes)

Thanks for stopping by! 🚀
---
*“Building scalable systems today, researching the AI of tomorrow.”*
